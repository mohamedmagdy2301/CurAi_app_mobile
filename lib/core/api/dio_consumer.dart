...
//   void _setUpCertificateBypass(Dio dio) {
...
//   void _addBaseInterceptors(Dio dio) {
...
//   void _setTimeouts(RequestOptions options) {
//     options
...
//   }) async {
//     return _safeApiCall(() {
//       final data = _buildRequestData(body, formDataIsEnabled);
...
//   dynamic _buildRequestData(dynamic body, bool formDataIsEnabled) {
